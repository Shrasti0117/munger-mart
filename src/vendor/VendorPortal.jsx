...
const VendorPortal = () => {
  ...
  const categories = [
    ...
    { id: 'medicine', label: 'Medicine Store', icon: '💊', lucide: Stethoscope, info: 'Health Care' },
    { id: 'general', label: 'General Store', icon: '🛍️', lucide: ShoppingBag, info: 'Daily Needs' },
  ...
  const businessTypes = ['Fresh Mandi', 'Medicine Store', 'General Store', 'Bakery', 'Stationary', 'Electric', 'Cafe/Chai'];
